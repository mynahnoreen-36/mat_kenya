...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const HomePageWidget() : const SignupPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => MapPageWidget(
            selectedRouteName: params.getParam(
              'selectedRouteName',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          name: RoutesPageWidget.routeName,
          path: RoutesPageWidget.routePath,
          builder: (context, params) => const RoutesPageWidget(),
        ),
        FFRoute(
          name: FaresPageWidget.routeName,
          path: FaresPageWidget.routePath,
          builder: (context, params) => FaresPageWidget(
