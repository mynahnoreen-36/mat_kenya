                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'wopejzjm' /* View current fare estimates fo... */,
                        ),
                    ...
                    StreamBuilder<List<RoutesRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<RoutesRecord> cardRoutesRecordList =
                            snapshot.data!;
                        // Return an empty Container when the item does not exist.
                        if (snapshot.data!.isEmpty) {
                          return Container();
                        }
                        final cardRoutesRecord = cardRoutesRecordList.isNotEmpty
                            ? cardRoutesRecordList.first
                            : null;
                    ...
                    Card(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            FFLocalizations.of(context).getText(
                              'bt5zjrhr' /* Standard fare estimate */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
