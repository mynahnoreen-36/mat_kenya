...
import 'schema/fares_record.dart';
...
export 'schema/fares_record.dart';
...
/// Functions to query FaresRecords (as a Stream and as a Future).
Future<int> queryFaresRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      FaresRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<FaresRecord>> queryFaresRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      FaresRecord.collection,
      FaresRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<FaresRecord>> queryFaresRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
