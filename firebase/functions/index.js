 ...
 * }
 */
exports.createDefaultAdmin = functions.https.onCall(async (data, context) => {
  ...
  try {
    ...
    try {
      ...
      console.log(`User with email ${email} already exists (UID: ${userRecord.uid})`);

      // User exists, just update their role in Firestore
      ...
      if (error.code === "auth/user-not-found") {
        ...
        console.log(`Successfully created admin user: ${email} (UID: ${uid})`);
